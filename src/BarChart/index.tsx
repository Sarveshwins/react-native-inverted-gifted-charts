    ...
    return (
      <>
        {horizSections.map((sectionItems, index) => {
          console.log("horizSections==", sectionItems)
          return (
              ...
              <View
                ...
                {!hideYAxisText && (
                  <Text
                    ...
                    ellipsizeMode={'clip'}
                    style={[
                     { color:props?.themeCustomization?"white":"black"},
                      yAxisTextStyle,
  ...
  return (
    <View
      ...
      <FlatList
        ...
        (
          {
            length: (props.spacing + props.barWidth),
            offset: ((props.spacing + props.barWidth) * index),
            index
          }
        )
